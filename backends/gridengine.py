...
"""
    ...
    def get_job_list(self, args):
        ...
        base_cmd += '-o {} '.format(os.path.join(log_dir, '$JOB_NAME_$JOB_ID_$TASK_ID.o')) # save stdout to file
        base_cmd += '-e {} '.format(os.path.join(log_dir, '$JOB_NAME_$JOB_ID_$TASK_ID.e')) # save stderr to file
